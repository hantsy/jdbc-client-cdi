...
public class JdbcConfig {
    ...
    /**
     * The JDBC placeholder symbol used when rewriting {@code :name} parameters (default {@code ?}).
     *
     * <p>Supported symbols and how {@code :name} is rewritten:
     * <ul>
     *   <li>{@code ?} — positional placeholder (MySQL and standard JDBC).</li>
     *   <li>{@code $} — numbered {@code $1}, {@code $2}, … (H2/PostgreSQL).</li>
     *   <li>{@code :} — numbered {@code :1}, {@code :2}, … (Oracle).</li>
     *   <li>{@code @} — named {@code @name}, preserving the parameter name (SQL Server).</li>
     * </ul>
     */
